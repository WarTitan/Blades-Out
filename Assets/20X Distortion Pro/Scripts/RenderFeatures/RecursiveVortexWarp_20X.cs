...
{
    public class RecursiveVortexWarp_20X : ScriptableRendererFeature
{
    [SerializeField]
    private Shader m_Shader;
    private Material material;
    RecursiveVortexWarp_Pass Distortion_RenderPass;
    public RenderPassEvent Event = RenderPassEvent.BeforeRenderingPostProcessing;

    public override void Create()
    {
        m_Shader = Shader.Find("DistortionsPro_20X/RecursiveVortexWarp");
        if (m_Shader == null)
        {
            return;
        }
        material = new Material(m_Shader);
        Distortion_RenderPass = new RecursiveVortexWarp_Pass(material);
    ...
    {
        RecursiveVortexWarp myVolume = VolumeManager.instance.stack?.GetComponent<RecursiveVortexWarp>();
    ...
    public class RecursiveVortexWarp_Pass : ScriptableRenderPass
    {
        static readonly int _Mask = Shader.PropertyToID("_Mask");
        static readonly int _FadeMultiplier = Shader.PropertyToID("_FadeMultiplier");
        static readonly int animTime = Shader.PropertyToID("animTime");
        ...
        public RecursiveVortexWarp_Pass(Material material)
        {
        ...
        public override void RecordRenderGraph(RenderGraph renderGraph, ContextContainer frameData)
        {
            ...
            var volumeComponent = VolumeManager.instance.stack.GetComponent<RecursiveVortexWarp>();
            _count += Time.deltaTime * volumeComponent.Speed.value;

            material.SetFloat(iterationCount, volumeComponent.MaximumImages.value);
            material.SetFloat(animTime, _count);
