...
{
    public class ZigzagJitterDisplacement_20X : ScriptableRendererFeature
    {
        [SerializeField]
        private Shader m_Shader;
        private Material material;
        ZigzagJitterDisplacement_Pass Distortion_RenderPass;
        public RenderPassEvent Event = RenderPassEvent.BeforeRenderingPostProcessing;

        public override void Create()
        {
            m_Shader = Shader.Find("DistortionsPro_20X/ZigzagJitterDisplacement");
            if (m_Shader == null)
            {
                return;
            }
            material = new Material(m_Shader);
            Distortion_RenderPass = new ZigzagJitterDisplacement_Pass(material);
        ...
        {
            ZigzagJitterDisplacement myVolume = VolumeManager.instance.stack?.GetComponent<ZigzagJitterDisplacement>();
        ...
        public class ZigzagJitterDisplacement_Pass : ScriptableRenderPass
        {
            static readonly int _Mask = Shader.PropertyToID("_Mask");
            static readonly int _FadeMultiplier = Shader.PropertyToID("_FadeMultiplier");
            static readonly int JitterSpeed = Shader.PropertyToID("JitterSpeed");
            static readonly int NoiseScale = Shader.PropertyToID("NoiseScale");
            static readonly int JitterAmount = Shader.PropertyToID("JitterAmount");
            static readonly int BlendFactor = Shader.PropertyToID("BlendFactor");
            private Material material;

            public ZigzagJitterDisplacement_Pass(Material material)
            {
            ...
            public override void RecordRenderGraph(RenderGraph renderGraph, ContextContainer frameData)
            {
                ...
                var volumeComponent = VolumeManager.instance.stack.GetComponent<ZigzagJitterDisplacement>();
                material.SetFloat(JitterAmount, volumeComponent.Intensity.value);

                material.SetFloat(NoiseScale, volumeComponent.Size.value);
                material.SetFloat(JitterSpeed, volumeComponent.Speed.value);
