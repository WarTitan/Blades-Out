...
{
    [VolumeComponentMenu("20X Distortions Pro/Worley Displacement")]
    public class WorleyDisplacement : VolumeComponent, IPostProcessComponent
    {
        ...
        public NoInterpClampedFloatParameter Size = new(0.056f, 0f, 1f);
        [Tooltip("Effect speed. Use this value to animate effect.")]
        public NoInterpClampedFloatParameter Speed = new(1f, 0f, 1f);
        [Tooltip("Effect transparancy.")]
        public NoInterpClampedFloatParameter Fade = new(1f, 0f, 1f);
        [Space]
