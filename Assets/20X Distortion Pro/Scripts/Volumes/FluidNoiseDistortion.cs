...
{
    [VolumeComponentMenu("20X Distortions Pro/FluidNoiseDistortion")]
    public class FluidNoiseDistortion : VolumeComponent, IPostProcessComponent
    {
        ...
        public NoInterpClampedFloatParameter Size = new(0.1f, 0f, 10);
        [Space]
